...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\edu6937995\\OneDrive - IKT Agder\\utvikling\\utvikling oppgave 3 våren\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\edu6937995\\OneDrive - IKT Agder\\utvikling\\utvikling oppgave 3 våren\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://postgres.cionesefvpdhxkgyvbzu:12345678@aws-0-eu-north-1.pooler.supabase.com:5432/postgres"
      }
    }
  },
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n  output   = \"../generated/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel User {\n  id        String   @id @default(cuid())\n  name      String\n  email     String   @unique\n  password  String\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n",
  "inlineSchemaHash": "8e28004b06507a6b4193cfed76b8088e737b6e7df269bfc1d060e452d5b27f44",
  "copyEngine": true
}
config.dirname = '/'
